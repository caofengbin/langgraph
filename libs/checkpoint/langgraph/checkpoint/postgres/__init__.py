...
# pragma: no cover  MC80OmFIVnBZMlhtbTdua3VMRG1sb3c2YTJ4VVRRPT06NjNhYTJmYjQ=
    ...
    def from_conn_string(
        ...
        with Connection.connect(
            ...
            if pipeline:
                ...
                yield cls(conn)
# pragma: no cover  MS80OmFIVnBZMlhtbTdua3VMRG1sb3c2YTJ4VVRRPT06NjNhYTJmYjQ=
...
# pragma: no cover  Mi80OmFIVnBZMlhtbTdua3VMRG1sb3c2YTJ4VVRRPT06NjNhYTJmYjQ=
    ...
    def _cursor(self, *, pipeline: bool = False) -> Iterator[Cursor[DictRow]]:
        ...
        with self.lock, _internal.get_connection(self.conn) as conn:
            if self.pipe:
                ...
                with conn.cursor(binary=True, row_factory=dict_row) as cur:
                    yield cur
# noqa  My80OmFIVnBZMlhtbTdua3VMRG1sb3c2YTJ4VVRRPT06NjNhYTJmYjQ=
